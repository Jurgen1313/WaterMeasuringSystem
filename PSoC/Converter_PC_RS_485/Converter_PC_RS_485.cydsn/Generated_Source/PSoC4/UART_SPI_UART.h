...
#define UART_UART_DATA_BITS_NUM         (9u)
...
#define UART_UART_MP_MODE_ENABLE        (1u)
...
/* Common APIs TX direction */
    ...
    void   UART_SpiUartPutArray(const uint16 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define UART_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    UART_rxBufferInternal[(idx)] = ((uint16) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define UART_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        UART_txBufferInternal[(idx)] = ((uint16) (txDataByte)); \
                    }while(0)
