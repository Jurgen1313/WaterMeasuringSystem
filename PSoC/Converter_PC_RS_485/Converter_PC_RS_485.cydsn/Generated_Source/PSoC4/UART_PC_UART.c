...
void UART_PC_UartPostEnable(void)
{
    ...
    #if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
        #if (UART_PC_SS0_PIN)
            if (UART_PC_CHECK_SS0_PIN_USED)
            {
                /* Set SCB UART to drive the output pin */
                UART_PC_SET_HSIOM_SEL(UART_PC_SS0_HSIOM_REG, UART_PC_SS0_HSIOM_MASK,
                                               UART_PC_SS0_HSIOM_POS, UART_PC_SS0_HSIOM_SEL_UART);
            }
...
void UART_PC_UartStop(void)
{
        ...
        if (UART_PC_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            if (UART_PC_CHECK_SS0_PIN_USED)
            {
                ...
                UART_PC_spi_ss0_Write(UART_PC_GET_UART_RTS_INACTIVE);

                /* Set GPIO to drive output pin */
                UART_PC_SET_HSIOM_SEL(UART_PC_SS0_HSIOM_REG, UART_PC_SS0_HSIOM_MASK,
                                               UART_PC_SS0_HSIOM_POS, UART_PC_SS0_HSIOM_SEL_GPIO);
            }
        #endif /* (UART_PC_SS0_PIN) */
    #endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
