// ======================================================================
// Converter_PC_RS_485.v generated from TopDesign.cysch
// 11/29/2017 at 23:32
...
module SCB_P4_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("fb7ecdab-443d-4a18-a314-ffcc0909890e/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fb7ecdab-443d-4a18-a314-ffcc0909890e/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fb7ecdab-443d-4a18-a314-ffcc0909890e/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=true, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=1, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=17, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_from_pc, CY_INSTANCE_SHORT_NAME=Timer_from_pc, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Timer_from_pc, )
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=true, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=1, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=17, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_from_slave, CY_INSTANCE_SHORT_NAME=Timer_from_slave, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Timer_from_slave, )
...
module top ;
	...
	wire [0:0] tmpOE__Rs485_send_net;
	wire [0:0] tmpFB_0__Rs485_send_net;
	wire [0:0] tmpIO_0__Rs485_send_net;
	wire [0:0] tmpINTERRUPT_0__Rs485_send_net;
	electrical [0:0] tmpSIOVREF__Rs485_send_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Rs485_send
		 (.oe(tmpOE__Rs485_send_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Rs485_send_net[0:0]}),
		  .io({tmpIO_0__Rs485_send_net[0:0]}),
		  .siovref(tmpSIOVREF__Rs485_send_net),
		  .interrupt({tmpINTERRUPT_0__Rs485_send_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rs485_send_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_20_0 UART_RS_485 (
        .cts_in(1'b0),
        .tx_out(Net_73),
        .rts_out(Net_74),
        .interrupt(Net_75),
	...
	cy_clock_v1_0
		#(.id("d205b12e-62e0-475b-83ca-8a57563149ba"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("f367954c-2b5c-4cd0-8a5f-b5f802ae79c7"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
    ...
    Timer_v2_70_3 Timer_from_pc (
        ...
        .tc(Net_213),
        .clock(Net_220));
    defparam Timer_from_pc.CaptureCount = 2;
    defparam Timer_from_pc.CaptureCounterEnabled = 0;
    defparam Timer_from_pc.DeviceFamily = "PSoC4";
    defparam Timer_from_pc.InterruptOnCapture = 0;
    defparam Timer_from_pc.InterruptOnTC = 1;
    defparam Timer_from_pc.Resolution = 16;
    defparam Timer_from_pc.SiliconRevision = "17";
    ...
    Timer_v2_70_4 Timer_from_slave (
        .reset(Net_223),
        .interrupt(Net_224),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_229),
        .clock(Net_220));
    defparam Timer_from_slave.CaptureCount = 2;
    defparam Timer_from_slave.CaptureCounterEnabled = 0;
    defparam Timer_from_slave.DeviceFamily = "PSoC4";
    defparam Timer_from_slave.InterruptOnCapture = 0;
    defparam Timer_from_slave.InterruptOnTC = 1;
    defparam Timer_from_slave.Resolution = 16;
    defparam Timer_from_slave.SiliconRevision = "17";


	cy_isr_v1_0
		#(.int_type(2'b10))
		isr_Timer_from_slave
		 (.int_signal(Net_229));
