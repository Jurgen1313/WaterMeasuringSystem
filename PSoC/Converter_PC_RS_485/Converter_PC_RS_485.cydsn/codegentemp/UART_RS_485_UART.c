...
void UART_RS_485_UartPostEnable(void)
{
        ...
        if (UART_RS_485_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            if (UART_RS_485_CHECK_SS0_PIN_USED)
            {
                /* Set SCB UART to drive the output pin */
                UART_RS_485_SET_HSIOM_SEL(UART_RS_485_SS0_HSIOM_REG, UART_RS_485_SS0_HSIOM_MASK,
                                               UART_RS_485_SS0_HSIOM_POS, UART_RS_485_SS0_HSIOM_SEL_UART);
            }
...
void UART_RS_485_UartStop(void)
{
        ...
        if (UART_RS_485_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            if (UART_RS_485_CHECK_SS0_PIN_USED)
            {
                ...
                UART_RS_485_spi_ss0_Write(UART_RS_485_GET_UART_RTS_INACTIVE);

                /* Set GPIO to drive output pin */
                UART_RS_485_SET_HSIOM_SEL(UART_RS_485_SS0_HSIOM_REG, UART_RS_485_SS0_HSIOM_MASK,
                                               UART_RS_485_SS0_HSIOM_POS, UART_RS_485_SS0_HSIOM_SEL_GPIO);
            }
        #endif /* (UART_RS_485_SS0_PIN) */
    #endif /* !(UART_RS_485_CY_SCBIP_V0 || UART_RS_485_CY_SCBIP_V1) */
