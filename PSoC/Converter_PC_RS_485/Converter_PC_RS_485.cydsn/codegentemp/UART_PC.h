...
#define UART_PC_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)
...
#define UART_PC_REMOVE_SCB_IRQ             (0u)
...
#define UART_PC_REMOVE_SCB_CLK     (0u)
#define UART_PC_SCB_CLK_INTERNAL   (0u == UART_PC_REMOVE_SCB_CLK)
...
#if (UART_PC_SCB_CLK_INTERNAL)
    #include "UART_PC_SCBCLK.h"
#endif /* (UART_PC_SCB_CLK_INTERNAL) */
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: UART_PC_EnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PC_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: UART_PC_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PC_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: UART_PC_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PC_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: UART_PC_GetInterruptCause
****************************************************************************//**
*
...
*    - UART_PC_INTR_CAUSE_MASTER - Interrupt from Master
*    - UART_PC_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - UART_PC_INTR_CAUSE_TX - Interrupt from TX
*    - UART_PC_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: UART_PC_GetRxInterruptSource
****************************************************************************//**
*
...
*   - UART_PC_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - UART_PC_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - UART_PC_INTR_RX_FULL - Receiver FIFO is full.
*   - UART_PC_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - UART_PC_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - UART_PC_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - UART_PC_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
*   UART_PC_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: UART_PC_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - UART_PC_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - UART_PC_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - UART_PC_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: UART_PC_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to UART_PC_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: UART_PC_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - UART_PC_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - UART_PC_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - UART_PC_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - UART_PC_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - UART_PC_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - UART_PC_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - UART_PC_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - UART_PC_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
*   UART_PC_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: UART_PC_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - UART_PC_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - UART_PC_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - UART_PC_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - UART_PC_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: UART_PC_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
/*******************************************************************************
* Function Name: UART_PC_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - UART_PC_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - UART_PC_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - UART_PC_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - UART_PC_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - UART_PC_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - UART_PC_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: UART_PC_SetMasterInterruptMode
****************************************************************************//**
*
...
*   UART_PC_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define UART_PC_SetMasterInterruptMode(interruptMask)  UART_PC_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: UART_PC_GetMasterInterruptMode
****************************************************************************//**
*
...
*   UART_PC_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define UART_PC_GetMasterInterruptMode()   (UART_PC_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: UART_PC_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to UART_PC_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: UART_PC_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - UART_PC_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - UART_PC_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - UART_PC_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - UART_PC_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - UART_PC_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - UART_PC_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - UART_PC_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - UART_PC_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - UART_PC_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - UART_PC_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: UART_PC_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   UART_PC_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define UART_PC_SetSlaveInterruptMode(interruptMask)   UART_PC_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: UART_PC_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   UART_PC_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define UART_PC_GetSlaveInterruptSourceMasked()    (UART_PC_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: UART_PC_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_PC_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to UART_PC_GetSlaveInterruptSource() 
...
#define UART_PC_STATUS_PTR             ( (reg32 *) UART_PC_SCB__STATUS)
    ...
    #define UART_PC_UART_TX_CTRL_PTR       ( (reg32 *) UART_PC_SCB__UART_TX_CTRL)
    ...
    #define UART_PC_UART_FLOW_CTRL_REG     (*(reg32 *) UART_PC_SCB__UART_FLOW_CTRL)
    #define UART_PC_UART_FLOW_CTRL_PTR     ( (reg32 *) UART_PC_SCB__UART_FLOW_CTRL)
...
#ifdef UART_PC_SCB__EZ_DATA0
    #define UART_PC_EZBUF_DATA0_REG    (*(reg32 *) UART_PC_SCB__EZ_DATA0)
    #define UART_PC_EZBUF_DATA0_PTR    ( (reg32 *) UART_PC_SCB__EZ_DATA0)
#else
    #define UART_PC_EZBUF_DATA0_REG    (*(reg32 *) UART_PC_SCB__EZ_DATA00)
    #define UART_PC_EZBUF_DATA0_PTR    ( (reg32 *) UART_PC_SCB__EZ_DATA00)
#endif /* UART_PC_SCB__EZ_DATA00 */
...
#define UART_PC_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define UART_PC_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define UART_PC_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define UART_PC_FF_DATA_NR_LOG2_MASK       (0x07u)      /* Number of bits to represent a FIFO address. */
#define UART_PC_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
#define UART_PC_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define UART_PC_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_CTRL_BYTE_MODE ((uint32) 0x01u << UART_PC_CTRL_BYTE_MODE_POS)
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
/* UART_PC_STATUS_REG */
#define UART_PC_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define UART_PC_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define UART_PC_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define UART_PC_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define UART_PC_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
#define UART_PC_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << UART_PC_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define UART_PC_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << UART_PC_SPI_CTRL_SSEL0_POLARITY_POS)
    #define UART_PC_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << UART_PC_SPI_CTRL_SSEL1_POLARITY_POS)
    #define UART_PC_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << UART_PC_SPI_CTRL_SSEL2_POLARITY_POS)
    #define UART_PC_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << UART_PC_SPI_CTRL_SSEL3_POLARITY_POS)
    #define UART_PC_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << UART_PC_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
/* UART_PC_UART_CTRL */
#define UART_PC_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
...
#define UART_PC_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define UART_PC_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define UART_PC_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define UART_PC_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define UART_PC_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    /* UART_PC_UART_FLOW_CTRL_REG */
    #define UART_PC_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define UART_PC_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define UART_PC_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define UART_PC_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define UART_PC_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK)
    #define UART_PC_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       UART_PC_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define UART_PC_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       UART_PC_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define UART_PC_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       UART_PC_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */

/* UART_PC_I2C_CTRL */
#define UART_PC_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define UART_PC_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define UART_PC_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define UART_PC_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define UART_PC_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define UART_PC_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define UART_PC_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
...
#else
#define UART_PC_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define UART_PC_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define UART_PC_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define UART_PC_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define UART_PC_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define UART_PC_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define UART_PC_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define UART_PC_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define UART_PC_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define UART_PC_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << UART_PC_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define UART_PC_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            UART_PC_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define UART_PC_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << UART_PC_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define UART_PC_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            UART_PC_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define UART_PC_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            UART_PC_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define UART_PC_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            UART_PC_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define UART_PC_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            UART_PC_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (UART_PC_CY_SCBIP_V0) */


/* UART_PC_TX_CTRL_REG */
#define UART_PC_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define UART_PC_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define UART_PC_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define UART_PC_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK)
...
#define UART_PC_TX_FIFO_STATUS_USED_MASK   ((uint32) UART_PC_FF_DATA_NR_LOG2_PLUS1_MASK)
#define UART_PC_TX_FIFO_SR_VALID           ((uint32) 0x01u << UART_PC_TX_FIFO_SR_VALID_POS)
#define UART_PC_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK << \
                                                                    UART_PC_TX_FIFO_STATUS_RD_PTR_POS)
#define UART_PC_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK << \
                                                                    UART_PC_TX_FIFO_STATUS_WR_PTR_POS)
...
/* UART_PC_RX_CTRL_REG */
#define UART_PC_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define UART_PC_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define UART_PC_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define UART_PC_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK)
...
#define UART_PC_RX_FIFO_STATUS_USED_MASK   ((uint32) UART_PC_FF_DATA_NR_LOG2_PLUS1_MASK)
#define UART_PC_RX_FIFO_SR_VALID           ((uint32) 0x01u << UART_PC_RX_FIFO_SR_VALID_POS)
#define UART_PC_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK << \
                                                                    UART_PC_RX_FIFO_STATUS_RD_PTR_POS)
#define UART_PC_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) UART_PC_FF_DATA_NR_LOG2_MASK << \
                                                                    UART_PC_RX_FIFO_STATUS_WR_PTR_POS)
...
#define UART_PC_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
...
#define UART_PC_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define UART_PC_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define UART_PC_INTR_TX_FIFO_LEVEL         (UART_PC_INTR_TX_TRIGGER)
...
#define UART_PC_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
#define UART_PC_INTR_RX_BREAK_DETECT_POS   (11u)  /* [11] Break detection is successful         */
#define UART_PC_INTR_RX_TRIGGER            ((uint32) 0x01u)
#define UART_PC_INTR_RX_FIFO_LEVEL         (UART_PC_INTR_RX_TRIGGER)
...
/* Return true if sourceMask is set in UART_PC_CTRL_REG: generally is used to check enable bit */
...
#define UART_PC_I2C_SLAVE_GENERATE_ACK \
    ...
    #define UART_PC_I2C_SLAVE_GENERATE_NACK UART_PC_I2CSlaveNackGeneration()
...
#define UART_PC_DIGITAL_FILTER_DISABLE    (0u)
#define UART_PC_DIGITAL_FILTER_ENABLE     (1u)
#define UART_PC_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (UART_PC_CY_SCBIP_V0)
    /* UART_PC_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define UART_PC_I2C_CFG_FILT_MASK  (UART_PC_I2C_CFG_SDA_FILT_ENABLED | \
                                                 UART_PC_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* UART_PC_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define UART_PC_I2C_CFG_FILT_MASK  (UART_PC_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 UART_PC_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (UART_PC_CY_SCBIP_V0) */

#define UART_PC_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            UART_PC_I2C_CFG_REG &= (uint32) ~UART_PC_I2C_CFG_FILT_MASK; \
        }while(0)

#define UART_PC_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            UART_PC_I2C_CFG_REG |= (uint32)  UART_PC_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return FIFO size depends on UART_PC_CTRL_BYTE_MODE bit */
#define UART_PC_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * UART_PC_FIFO_SIZE) : (UART_PC_FIFO_SIZE))
...
#if (UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define UART_PC_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (UART_PC_CTRL_BYTE_MODE) : (0u))
#endif /* (UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
#define UART_PC_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    UART_PC_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define UART_PC_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (UART_PC_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define UART_PC_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << UART_PC_I2C_CTRL_SLAVE_MODE_POS)
...
#define UART_PC_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define UART_PC_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define UART_PC_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (UART_PC_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define UART_PC_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     UART_PC_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     UART_PC_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */

#define UART_PC_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << UART_PC_SPI_CTRL_MODE_POS) & \
                                                                                 UART_PC_SPI_CTRL_MODE_MASK)

#define UART_PC_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      UART_PC_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      UART_PC_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* UART_PC_UART_CTRL */
#define UART_PC_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
/* UART_PC_UART_FLOW_CTRL */
#if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
    #define UART_PC_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 UART_PC_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define UART_PC_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (UART_PC_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define UART_PC_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (UART_PC_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define UART_PC_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (UART_PC_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
#define UART_PC_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
/* UART_PC_INTR_SLAVE_I2C_GENERAL */
#define UART_PC_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (UART_PC_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled UART_PC_SPI_CTRL_REG */
#define UART_PC_CHECK_SPI_MASTER   (0u != (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define UART_PC_GET_SPI_SCLK_INACTIVE \
            ((0u == (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
#define UART_PC_GET_SPI_SS0_INACTIVE       (1u)
#define UART_PC_GET_SPI_SS1_INACTIVE       (1u)
#define UART_PC_GET_SPI_SS2_INACTIVE       (1u)
#define UART_PC_GET_SPI_SS3_INACTIVE       (1u)
#define UART_PC_GET_UART_RTS_INACTIVE      (1u)

#else
#define UART_PC_GET_SPI_SS0_INACTIVE  \
        ((0u != (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define UART_PC_GET_SPI_SS1_INACTIVE  \
        ((0u != (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define UART_PC_GET_SPI_SS2_INACTIVE  \
        ((0u != (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define UART_PC_GET_SPI_SS3_INACTIVE  \
        ((0u != (UART_PC_SPI_CTRL_REG & UART_PC_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define UART_PC_GET_UART_RTS_INACTIVE \
        ((0u == (UART_PC_UART_FLOW_CTRL_REG & UART_PC_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define UART_PC_CY_SCBIP_V1_I2C_ONLY   (UART_PC_CY_SCBIP_V1)
#define UART_PC_EZBUFFER_SIZE          (UART_PC_EZ_DATA_NR)

#define UART_PC_EZBUF_DATA00_REG   UART_PC_EZBUF_DATA0_REG
#define UART_PC_EZBUF_DATA00_PTR   UART_PC_EZBUF_DATA0_PTR
