...
/* Timer/Counter Mode */
/* Parameters */
#define Counter_6_TC_RUN_MODE                    (1lu)
#define Counter_6_TC_COUNTER_MODE                (0lu)
#define Counter_6_TC_COMP_CAP_MODE               (2lu)
#define Counter_6_TC_PRESCALER                   (0lu)

/* Signal modes */
#define Counter_6_TC_RELOAD_SIGNAL_MODE          (0lu)
#define Counter_6_TC_COUNT_SIGNAL_MODE           (3lu)
#define Counter_6_TC_START_SIGNAL_MODE           (0lu)
#define Counter_6_TC_STOP_SIGNAL_MODE            (1lu)
#define Counter_6_TC_CAPTURE_SIGNAL_MODE         (0lu)

/* Signal present */
#define Counter_6_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define Counter_6_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define Counter_6_TC_START_SIGNAL_PRESENT        (0lu)
#define Counter_6_TC_STOP_SIGNAL_PRESENT         (1lu)
...
/* Timer/Counter Mode */
#define Counter_6_TC_PERIOD_VALUE                (65535lu)
