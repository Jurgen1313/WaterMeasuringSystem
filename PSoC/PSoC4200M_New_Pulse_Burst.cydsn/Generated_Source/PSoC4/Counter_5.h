...
/* Signal present */
#define Counter_5_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define Counter_5_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define Counter_5_TC_START_SIGNAL_PRESENT        (0lu)
#define Counter_5_TC_STOP_SIGNAL_PRESENT         (1lu)
...
/* Timer/Counter Mode */
#define Counter_5_TC_PERIOD_VALUE                (65535lu)
