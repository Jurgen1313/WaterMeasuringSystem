...
/* Timer/Counter Mode */
/* Parameters */
#define Counter_1_TC_RUN_MODE                    (1lu)
#define Counter_1_TC_COUNTER_MODE                (0lu)
#define Counter_1_TC_COMP_CAP_MODE               (0lu)
#define Counter_1_TC_PRESCALER                   (0lu)

/* Signal modes */
#define Counter_1_TC_RELOAD_SIGNAL_MODE          (1lu)
#define Counter_1_TC_COUNT_SIGNAL_MODE           (1lu)
#define Counter_1_TC_START_SIGNAL_MODE           (0lu)
#define Counter_1_TC_STOP_SIGNAL_MODE            (0lu)
#define Counter_1_TC_CAPTURE_SIGNAL_MODE         (0lu)

/* Signal present */
#define Counter_1_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define Counter_1_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define Counter_1_TC_START_SIGNAL_PRESENT        (0lu)
#define Counter_1_TC_STOP_SIGNAL_PRESENT         (1lu)
...
#define Counter_1_TC_COMPARE_VALUE               (65534lu)
