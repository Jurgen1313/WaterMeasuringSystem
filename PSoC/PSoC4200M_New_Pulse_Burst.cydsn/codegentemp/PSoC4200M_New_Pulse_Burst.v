// ======================================================================
// PSoC4200M_New_Pulse_Burst.v generated from TopDesign.cysch
// 12/26/2017 at 14:23
...
module top ;
    ...
    TCPWM_P4_v2_10_1 ExamplaryCounter (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_369),
	...
	wire [6:0] tmpOE__Channel_1_net;
	wire [6:0] tmpIO_6__Channel_1_net;
	electrical [0:0] tmpSIOVREF__Channel_1_net;

	cy_psoc3_pins_v1_10
		#(.id("dd592a5f-9cbb-49b3-879a-961ff64c2464"),
		  .drive_mode(21'b011_011_011_011_011_011_011),
		...
		Channel_1
		 (.oe(tmpOE__Channel_1_net),
		  .y({7'b0}),
		  .fb({Counter7, Counter6, Counter5, Counter4, Counter3, Counter2, Counter1}),
		  .io({tmpIO_6__Channel_1_net[6:0]}),
	...
	assign tmpOE__Channel_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{7'b1111111} : {7'b1111111};
