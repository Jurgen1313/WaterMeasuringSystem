...
#define PWM_1_PWM_STOP_SIGNAL_MODE           (1lu)
...
#define PWM_1_PWM_STOP_SIGNAL_PRESENT        (1lu)
#define PWM_1_PWM_SWITCH_SIGNAL_PRESENT      (0lu)

/* Interrupt Mask */
#define PWM_1_PWM_INTERRUPT_MASK             (2lu)
