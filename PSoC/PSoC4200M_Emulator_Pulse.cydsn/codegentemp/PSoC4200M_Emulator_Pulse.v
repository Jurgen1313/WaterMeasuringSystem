// ======================================================================
// PSoC4200M_Emulator_Pulse.v generated from TopDesign.cysch
// 12/16/2017 at 12:16
...
module top ;
    ...
    Timer_v2_70_1 Timer_from_master (
        .reset(Net_12),
        .interrupt(Net_468),
        .enable(1'b1),
        .trigger(1'b1),
	...
	cy_psoc3_pins_v1_10
		...
		LED
		 (.oe(tmpOE__LED_net),
		  .y({Net_484, Net_483, Net_482, Net_481, Net_480, Net_479, Net_478, Net_477}),
    ...
    TCPWM_P4_v2_10_2 PWM_Exemplary (
        .stop(PWMExemplary),
        .reload(1'b0),
        .start(PWMExemplary),
        .count(1'b1),
