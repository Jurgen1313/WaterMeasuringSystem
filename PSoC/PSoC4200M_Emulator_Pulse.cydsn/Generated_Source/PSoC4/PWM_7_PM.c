...
static PWM_7_BACKUP_STRUCT PWM_7_backup;
...
{
    if(0u != (PWM_7_BLOCK_CONTROL_REG & PWM_7_MASK))
    {
        PWM_7_backup.enableState = 1u;
    }
    else
    {
        PWM_7_backup.enableState = 0u;
    }
...
void PWM_7_Wakeup(void)
{
    ...
    if(0u != PWM_7_backup.enableState)
    {
        PWM_7_Enable();
    }
}
