...
void DMA_1_Start(void * srcAddress, void * dstAddress)
{
    ...
    CyDmaEnable();
    DMA_1_SetSrcAddress(0, srcAddress);
    DMA_1_SetDstAddress(0, dstAddress);
...
*  customizer. It is not necessary to call DMA_1_Init() because the
*  DMA_1_Start() API calls this function, which is the preferred method
...
{
    CYDMA_CH_CTL_BASE.ctl[DMA_1_CHANNEL] = DMA_1_CHANNEL_CFG;
    CYDMA_DESCR_BASE.descriptor[DMA_1_CHANNEL][0].ctl = DMA_1_DESCR0_CFG;
    CYDMA_DESCR_BASE.descriptor[DMA_1_CHANNEL][1].ctl = DMA_1_DESCR1_CFG;

    /* If the Generate IRQ option is selected for descriptor 0 or 1, set the
    * channel bit field in the DMA interrupt mask register.
    */
    #if (0u != ((DMA_1_DESCR0_CFG | DMA_1_DESCR1_CFG) & CYDMA_GENERATE_IRQ))
        CYDMA_INTR_MASK_REG |= DMA_1_CHANNEL_MASK;
    #endif /* (0u != ((DMA_1_DESCR0_CFG | DMA_1_DESCR1_CFG) & CYDMA_GENERATE_IRQ)) */
}
