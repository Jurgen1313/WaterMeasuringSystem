...
#define UART_PC_SPI_BYTE_MODE_ENABLE       (0u)
#define UART_PC_SPI_FREE_RUN_SCLK_ENABLE   (0u)
#define UART_PC_SPI_SS0_POLARITY           (0u)
#define UART_PC_SPI_SS1_POLARITY           (0u)
#define UART_PC_SPI_SS2_POLARITY           (0u)
#define UART_PC_SPI_SS3_POLARITY           (0u)
...
#define UART_PC_UART_STOP_BITS_NUM         (4u)
...
#define UART_PC_UART_INTERRUPT_MODE        (1u)

#define UART_PC_UART_INTR_RX_MASK          (4u)
#define UART_PC_UART_INTR_TX_MASK          (0u)

#define UART_PC_UART_RX_TRIGGER_LEVEL      (7u)
#define UART_PC_UART_TX_TRIGGER_LEVEL      (0u)

#define UART_PC_UART_BYTE_MODE_ENABLE      (0u)
#define UART_PC_UART_CTS_ENABLE            (0u)
#define UART_PC_UART_CTS_POLARITY          (0u)
#define UART_PC_UART_RTS_ENABLE            (0u)
#define UART_PC_UART_RTS_POLARITY          (0u)
#define UART_PC_UART_RTS_FIFO_LEVEL        (4u)
...
****************************************/
    ...
    /* Mode */
    #define UART_PC_SPI_SLAVE_CONST        (1u)
    #define UART_PC_SPI_MASTER_CONST       (1u)
    ...
    #define UART_PC_INTERNAL_RX_BUFFER_SIZE    (UART_PC_rxBufferSize + 1u)
    ...
    #define UART_PC_CHECK_SPI_WAKE_ENABLE  ((0u != UART_PC_scbEnableWake) && UART_PC_SCB_MODE_SPI_RUNTM_CFG)
    #define UART_PC_CHECK_UART_WAKE_ENABLE ((0u != UART_PC_scbEnableWake) && UART_PC_SCB_MODE_UART_RUNTM_CFG)

    /* SPI/UART: TX or RX FIFO size */
    #if (UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
        #define UART_PC_SPI_UART_FIFO_SIZE             (UART_PC_FIFO_SIZE)
        #define UART_PC_CHECK_UART_RTS_CONTROL_FLOW    (0u)
    #else
        #define UART_PC_SPI_UART_FIFO_SIZE (UART_PC_GET_FIFO_SIZE(UART_PC_CTRL_REG & \
                                                                                    UART_PC_CTRL_BYTE_MODE))

        #define UART_PC_CHECK_UART_RTS_CONTROL_FLOW \
                    ((UART_PC_SCB_MODE_UART_RUNTM_CFG) && \
                     (0u != UART_PC_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(UART_PC_UART_FLOW_CTRL_REG)))
    ...
    /* Internal RX and TX buffer: for SPI or UART */
        ...
        /* Get FIFO size */
        #define UART_PC_SPI_UART_FIFO_SIZE UART_PC_GET_FIFO_SIZE(UART_PC_SPI_BYTE_MODE_ENABLE)

        /* SPI internal RX and TX buffers */
        #define UART_PC_INTERNAL_SPI_RX_SW_BUFFER  (UART_PC_SPI_RX_BUFFER_SIZE > \
                                                                UART_PC_SPI_UART_FIFO_SIZE)
        ...
        #define UART_PC_INTERNAL_RX_BUFFER_SIZE    (UART_PC_SPI_RX_BUFFER_SIZE + 1u)
        #define UART_PC_RX_BUFFER_SIZE             (UART_PC_SPI_RX_BUFFER_SIZE)
        ...
        /* Get FIFO size */
        #define UART_PC_SPI_UART_FIFO_SIZE UART_PC_GET_FIFO_SIZE(UART_PC_UART_BYTE_MODE_ENABLE)
        ...
        #define UART_PC_INTERNAL_RX_BUFFER_SIZE    (UART_PC_UART_RX_BUFFER_SIZE + 1u)
        #define UART_PC_RX_BUFFER_SIZE             (UART_PC_UART_RX_BUFFER_SIZE)
    ...
    /* Mode */
    #define UART_PC_SPI_SLAVE_CONST    (UART_PC_SPI_MODE == UART_PC_SPI_SLAVE)
    #define UART_PC_SPI_MASTER_CONST   (UART_PC_SPI_MODE == UART_PC_SPI_MASTER)
    ...
    #define UART_PC_CHECK_UART_WAKE_ENABLE (UART_PC_UART_WAKE_ENABLE_CONST)

    /* UART flow control: not applicable for CY_SCBIP_V0 || CY_SCBIP_V1 */
    #define UART_PC_CHECK_UART_RTS_CONTROL_FLOW    (UART_PC_SCB_MODE_UART_CONST_CFG && \
                                                             UART_PC_UART_RTS_ENABLE)
...
{   
    ...
    */
     ...
     *  choices: 
     *  - UART_PC_SPI_MODE_MOTOROLA 
     *  - UART_PC_SPI_MODE_TI_COINCIDES
     *  - UART_PC_SPI_MODE_TI_PRECEDES
     *  - UART_PC_SPI_MODE_NATIONAL
    */
    uint32 submode;
     ...
     *  - UART_PC_SPI_SCLK_CPHA0_CPOL0
     *  - UART_PC_SPI_SCLK_CPHA0_CPOL1
     *  - UART_PC_SPI_SCLK_CPHA1_CPOL0
     *  - UART_PC_SPI_SCLK_CPHA1_CPOL1
    */
    uint32 sclkMode;
    ...
    */
     ...
     *  choices:
     *  - UART_PC_BITS_ORDER_LSB_FIRST
     *  - UART_PC_BITS_ORDER_MSB_FIRST
    */
    uint32 bitOrder;
     ...
     *  available choices: 
     *  - UART_PC_SPI_TRANSFER_CONTINUOUS
     *  - UART_PC_SPI_TRANSFER_SEPARATED
    */
     ...
     *  buffer.
     *  The UART_PC_INTR _RX_NOT_EMPTY interrupt has to be enabled to 
    ...
    */
     ...
     *  UART_PC_SPI_SLAVE_SELECT0 corresponds to slave select 0 
     *  polarity, bit UART_PC_SPI_SLAVE_SELECT1 – slave select 1 
     *  polarity and so on. Polarity constants are: 
     *  - UART_PC_SPI_SS_ACTIVE_LOW 
     *  - UART_PC_SPI_SS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
...
typedef struct
{
     ...
     *  choices:
     *  - UART_PC_UART_MODE_STD
     *  - UART_PC_UART_MODE_SMARTCARD 
     *  - UART_PC_UART_MODE_IRDA
    */
    uint32 mode;
    ...
    */
     ...
     *  - UART_PC_UART_PARITY_EVEN
     *  - UART_PC_UART_PARITY_ODD
     *  - UART_PC_UART_PARITY_NONE
    */
    uint32 parity;
    
    /** Determines the number of stop bits. The following defines are available 
     *  choices:
     *  - UART_PC_UART_STOP_BITS_1
     *  - UART_PC_UART_STOP_BITS_1_5
     *  - UART_PC_UART_STOP_BITS_2
    */
    uint32 stopBits;
     ...
     *  is enabled:
     *  - UART_PC_UART_IRDA_LP_OVS16
     *  - UART_PC_UART_IRDA_LP_OVS32
     *  - UART_PC_UART_IRDA_LP_OVS48
     *  - UART_PC_UART_IRDA_LP_OVS96
     *  - UART_PC_UART_IRDA_LP_OVS192
     *  - UART_PC_UART_IRDA_LP_OVS768
     *  - UART_PC_UART_IRDA_LP_OVS1536
    */
    uint32 oversample;
    ...
    */    
     ...
     *  - UART_PC_UART_CTS_ACTIVE_LOW
     *  - UART_PC_UART_CTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
    ...
    */
     ...
     *  - UART_PC_UART_RTS_ ACTIVE_LOW 
     *  - UART_PC_UART_RTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
...
/* SPI specific functions */
    ...
    /*******************************************************************************
    * Function Name: UART_PC_SpiIsBusBusy
    ****************************************************************************//**
    *
    ...
    *
    *******************************************************************************/
    #define UART_PC_SpiIsBusBusy() ((uint32) (0u != (UART_PC_SPI_STATUS_REG & \
                                                              UART_PC_SPI_STATUS_BUS_BUSY)))

    #if (UART_PC_SPI_MASTER_CONST)
        void UART_PC_SpiSetActiveSlaveSelect(uint32 slaveSelect);
    #endif /*(UART_PC_SPI_MASTER_CONST) */

    #if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
        void UART_PC_SpiSetSlaveSelectPolarity(uint32 slaveSelect, uint32 polarity);
    #endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
/* UART specific functions */
    ...
    /* UART RX direction APIs */
        ...
        uint32 UART_PC_UartGetByte(void);
            ...
            void UART_PC_UartSetRtsPolarity(uint32 polarity);
            void UART_PC_UartSetRtsFifoLevel(uint32 level);
        #endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
    ...
    /* UART TX direction APIs */
        ...
        /*******************************************************************************
        * Function Name: UART_PC_UartPutChar
        ****************************************************************************//**
        *
        ...
        *  Use UART_PC_UART_MP_MARK to add a mark to create an address byte.
        *
        ...
        *******************************************************************************/
        ...
        #if !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1)
            /* UART APIs for Flow Control */
            void UART_PC_UartEnableCts(void);
            void UART_PC_UartDisableCts(void);
            void UART_PC_UartSetCtsPolarity(uint32 polarity);
        #endif /* !(UART_PC_CY_SCBIP_V0 || UART_PC_CY_SCBIP_V1) */
...
#define UART_PC_SPI_MODE_NS_MICROWIRE  (UART_PC_SPI_MODE_NATIONAL)
...
#define UART_PC_SPI_SLAVE_SELECT0    (UART_PC_SCB__SS0_POSISTION)
#define UART_PC_SPI_SLAVE_SELECT1    (UART_PC_SCB__SS1_POSISTION)
#define UART_PC_SPI_SLAVE_SELECT2    (UART_PC_SCB__SS2_POSISTION)
#define UART_PC_SPI_SLAVE_SELECT3    (UART_PC_SCB__SS3_POSISTION)

/* SPI slave select polarity settings */
#define UART_PC_SPI_SS_ACTIVE_LOW  (0u)
#define UART_PC_SPI_SS_ACTIVE_HIGH (1u)

#define UART_PC_INTR_SPIM_TX_RESTORE   (UART_PC_INTR_TX_OVERFLOW)

#define UART_PC_INTR_SPIS_TX_RESTORE     (UART_PC_INTR_TX_OVERFLOW | \
                                                 UART_PC_INTR_TX_UNDERFLOW)
...
#define UART_PC_UART_CTS_ACTIVE_LOW    (0u)
#define UART_PC_UART_CTS_ACTIVE_HIGH   (1u)
#define UART_PC_UART_RTS_ACTIVE_LOW    (0u)
#define UART_PC_UART_RTS_ACTIVE_HIGH   (1u)
...
/* Shifted INTR_RX_ERR defines ONLY for UART_PC_UartGetByte() */
#define UART_PC_UART_RX_OVERFLOW       (UART_PC_INTR_RX_OVERFLOW << 8u)
#define UART_PC_UART_RX_UNDERFLOW      (UART_PC_INTR_RX_UNDERFLOW << 8u)
#define UART_PC_UART_RX_FRAME_ERROR    (UART_PC_INTR_RX_FRAME_ERROR << 8u)
#define UART_PC_UART_RX_PARITY_ERROR   (UART_PC_INTR_RX_PARITY_ERROR << 8u)
#define UART_PC_UART_RX_ERROR_MASK     (UART_PC_UART_RX_OVERFLOW    | \
                                                 UART_PC_UART_RX_UNDERFLOW   | \
                                                 UART_PC_UART_RX_FRAME_ERROR | \
                                                 UART_PC_UART_RX_PARITY_ERROR)

#define UART_PC_INTR_UART_TX_RESTORE   (UART_PC_INTR_TX_OVERFLOW  | \
                                                 UART_PC_INTR_TX_UART_NACK | \
                                                 UART_PC_INTR_TX_UART_DONE | \
                                                 UART_PC_INTR_TX_UART_ARB_LOST)
...
#if (UART_PC_UART_WAKE_ENABLE_CONST && UART_PC_UART_RX_WAKEUP_IRQ)
    extern uint8 UART_PC_skipStart;
#endif /* (UART_PC_UART_WAKE_ENABLE_CONST && UART_PC_UART_RX_WAKEUP_IRQ) */
...
#define UART_PC_SPI_SS_POLARITY \
             (((uint32) UART_PC_SPI_SS0_POLARITY << UART_PC_SPI_SLAVE_SELECT0) | \
              ((uint32) UART_PC_SPI_SS1_POLARITY << UART_PC_SPI_SLAVE_SELECT1) | \
              ((uint32) UART_PC_SPI_SS2_POLARITY << UART_PC_SPI_SLAVE_SELECT2) | \
              ((uint32) UART_PC_SPI_SS3_POLARITY << UART_PC_SPI_SLAVE_SELECT3))
    ...
    #define UART_PC_SPI_DEFAULT_CTRL \
                    (UART_PC_GET_CTRL_OVS(UART_PC_SPI_OVS_FACTOR) | \
                     UART_PC_GET_CTRL_BYTE_MODE (UART_PC_SPI_BYTE_MODE_ENABLE) | \
    ...
    #define UART_PC_SPI_DEFAULT_SPI_CTRL \
                    (UART_PC_GET_SPI_CTRL_CONTINUOUS    (UART_PC_SPI_TRANSFER_SEPARATION)       | \
                     ...
                     UART_PC_GET_SPI_CTRL_SCLK_CONTINUOUS(UART_PC_SPI_FREE_RUN_SCLK_ENABLE)     | \
                     UART_PC_GET_SPI_CTRL_SSEL_POLARITY (UART_PC_SPI_SS_POLARITY)               | \
...
***************************************/
    ...
    #define UART_PC_UART_DEFAULT_CTRL \
                                (UART_PC_GET_CTRL_BYTE_MODE  (UART_PC_UART_BYTE_MODE_ENABLE)  | \
    ...
    #define UART_PC_UART_DEFAULT_FLOW_CTRL \
                        (UART_PC_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(UART_PC_UART_RTS_FIFO_LEVEL) | \
                         UART_PC_GET_UART_FLOW_CTRL_RTS_POLARITY (UART_PC_UART_RTS_POLARITY)   | \
                         UART_PC_GET_UART_FLOW_CTRL_CTS_POLARITY (UART_PC_UART_CTS_POLARITY)   | \
                         UART_PC_GET_UART_FLOW_CTRL_CTS_ENABLE   (UART_PC_UART_CTS_ENABLE))
...
#define UART_PC_SPIM_ACTIVE_SS0    (UART_PC_SPI_SLAVE_SELECT0)
#define UART_PC_SPIM_ACTIVE_SS1    (UART_PC_SPI_SLAVE_SELECT1)
#define UART_PC_SPIM_ACTIVE_SS2    (UART_PC_SPI_SLAVE_SELECT2)
#define UART_PC_SPIM_ACTIVE_SS3    (UART_PC_SPI_SLAVE_SELECT3)
