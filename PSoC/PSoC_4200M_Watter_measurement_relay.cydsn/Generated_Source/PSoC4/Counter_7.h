...
/* Timer/Counter Mode */
/* Parameters */
#define Counter_7_TC_RUN_MODE                    (0lu)
#define Counter_7_TC_COUNTER_MODE                (1lu)
#define Counter_7_TC_COMP_CAP_MODE               (2lu)
#define Counter_7_TC_PRESCALER                   (0lu)

/* Signal modes */
#define Counter_7_TC_RELOAD_SIGNAL_MODE          (0lu)
#define Counter_7_TC_COUNT_SIGNAL_MODE           (1lu)
#define Counter_7_TC_START_SIGNAL_MODE           (0lu)
#define Counter_7_TC_STOP_SIGNAL_MODE            (0lu)
#define Counter_7_TC_CAPTURE_SIGNAL_MODE         (0lu)

/* Signal present */
#define Counter_7_TC_RELOAD_SIGNAL_PRESENT       (0lu)
#define Counter_7_TC_COUNT_SIGNAL_PRESENT        (1lu)
#define Counter_7_TC_START_SIGNAL_PRESENT        (0lu)
#define Counter_7_TC_STOP_SIGNAL_PRESENT         (0lu)
...
/* Timer/Counter Mode */
#define Counter_7_TC_PERIOD_VALUE                (65534lu)
