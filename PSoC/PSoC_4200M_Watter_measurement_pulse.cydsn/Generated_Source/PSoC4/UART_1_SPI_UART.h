...
#define UART_1_UART_DATA_BITS_NUM         (9u)
...
#define UART_1_UART_MP_MODE_ENABLE        (1u)
...
#define UART_1_UART_INTR_TX_MASK          (512u)
...
/* Common APIs TX direction */
    ...
    void   UART_1_SpiUartPutArray(const uint16 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define UART_1_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    UART_1_rxBufferInternal[(idx)] = ((uint16) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define UART_1_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        UART_1_txBufferInternal[(idx)] = ((uint16) (txDataByte)); \
                    }while(0)
