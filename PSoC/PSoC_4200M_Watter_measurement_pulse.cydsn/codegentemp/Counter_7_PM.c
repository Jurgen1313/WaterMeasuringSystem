...
static Counter_7_BACKUP_STRUCT Counter_7_backup;
...
{
    if(0u != (Counter_7_BLOCK_CONTROL_REG & Counter_7_MASK))
    {
        Counter_7_backup.enableState = 1u;
    }
    else
    {
        Counter_7_backup.enableState = 0u;
    }
...
void Counter_7_Wakeup(void)
{
    ...
    if(0u != Counter_7_backup.enableState)
    {
        Counter_7_Enable();
    }
}
