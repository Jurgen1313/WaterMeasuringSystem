// ======================================================================
// PSoC_4200M_Watter_measurement_pulse.v generated from TopDesign.cysch
// 12/16/2017 at 12:11
...
module top ;
    ...
    TCPWM_P4_v2_10_0 ExamplaryCounter (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_369),
	...
	cy_psoc3_pins_v1_10
		#(.id("073fc353-543e-45c1-a44a-39fdc529585e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f06de86c-e9c6-47fe-85cc-da174a934f41"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f895c431-721c-4001-bfee-9fc944fdd745"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8dac53f8-a474-4646-95c3-c95d71342230"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7acc4058-cc55-4090-9985-9adc1a57a1aa"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2c428428-55c1-49a0-8e77-8c4cdac3e20f"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		...
		Led
		 (.oe(tmpOE__Led_net),
		  ...
		  .annotation({Net_651, Net_649, Net_654, Net_648, Net_657, Net_656, Net_617, Net_616}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    cy_annotation_universal_v1_0 Ch_1 (
        .connect({
            Net_628,
            Net_652
        })
    );
    defparam Ch_1.comp_name = "LED_v1_0";
    defparam Ch_1.port_names = "A, K";
    defparam Ch_1.width = 2;

    cy_annotation_universal_v1_0 Ch_2 (
        .connect({
            Net_630,
            Net_652
        })
    );
    defparam Ch_2.comp_name = "LED_v1_0";
    defparam Ch_2.port_names = "A, K";
    defparam Ch_2.width = 2;

    cy_annotation_universal_v1_0 Ch_3 (
        .connect({
            Net_632,
            Net_652
        })
    );
    defparam Ch_3.comp_name = "LED_v1_0";
    defparam Ch_3.port_names = "A, K";
    defparam Ch_3.width = 2;

    cy_annotation_universal_v1_0 Ch_4 (
        .connect({
            Net_634,
            Net_652
        })
    );
    defparam Ch_4.comp_name = "LED_v1_0";
    defparam Ch_4.port_names = "A, K";
    defparam Ch_4.width = 2;

    cy_annotation_universal_v1_0 Ch_5 (
        .connect({
            Net_636,
            Net_652
        })
    );
    defparam Ch_5.comp_name = "LED_v1_0";
    defparam Ch_5.port_names = "A, K";
    defparam Ch_5.width = 2;

    cy_annotation_universal_v1_0 Ch_6 (
        .connect({
            Net_638,
            Net_652
        })
    );
    defparam Ch_6.comp_name = "LED_v1_0";
    defparam Ch_6.port_names = "A, K";
    defparam Ch_6.width = 2;

    cy_annotation_universal_v1_0 Ch_7 (
        .connect({
            Net_640,
            Net_652
        })
    );
    defparam Ch_7.comp_name = "LED_v1_0";
    defparam Ch_7.port_names = "A, K";
    defparam Ch_7.width = 2;

    cy_annotation_universal_v1_0 Ch_8 (
        .connect({
            Net_642,
            Net_652
        })
    );
    defparam Ch_8.comp_name = "LED_v1_0";
    defparam Ch_8.port_names = "A, K";
    defparam Ch_8.width = 2;
	...
	wire [3:0] tmpOE__PinAddr_net;
	wire [3:0] tmpFB_3__PinAddr_net;
	wire [3:0] tmpIO_3__PinAddr_net;
	wire [0:0] tmpINTERRUPT_0__PinAddr_net;
	electrical [0:0] tmpSIOVREF__PinAddr_net;
	...
	cy_psoc3_pins_v1_10
		...
		PinAddr
		 (.oe(tmpOE__PinAddr_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__PinAddr_net[3:0]}),
		  .io({tmpIO_3__PinAddr_net[3:0]}),
		  .siovref(tmpSIOVREF__PinAddr_net),
		  .interrupt({tmpINTERRUPT_0__PinAddr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinAddr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
