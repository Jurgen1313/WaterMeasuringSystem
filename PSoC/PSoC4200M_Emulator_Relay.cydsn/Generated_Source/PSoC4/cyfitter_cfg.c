...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL1, 0x000F9F00u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL15), 0x00000041u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL13), 0x00000041u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x08080899u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x93B40000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT0_TR_CTRL0), 0x00077010u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00099010u);

		/* TCPWM_CNT2 Starting address: CYDEV_TCPWM_CNT2_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT2_TR_CTRL0), 0x00022010u);

		/* TCPWM_CNT3 Starting address: CYDEV_TCPWM_CNT3_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x000CC010u);

		/* TCPWM_CNT4 Starting address: CYDEV_TCPWM_CNT4_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT4_TR_CTRL0), 0x00044010u);

		/* TCPWM_CNT5 Starting address: CYDEV_TCPWM_CNT5_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT5_TR_CTRL0), 0x00066010u);

		/* TCPWM_CNT6 Starting address: CYDEV_TCPWM_CNT6_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT6_TR_CTRL0), 0x000AA010u);

		/* TCPWM_CNT7 Starting address: CYDEV_TCPWM_CNT7_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT7_TR_CTRL0), 0x000BB010u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000056u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x001861B1u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x00000002u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000055u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x0079E79Eu);
