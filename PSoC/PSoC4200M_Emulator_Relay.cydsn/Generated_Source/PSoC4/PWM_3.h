...
#define PWM_3_PWM_STOP_EVENT                 (1lu)
#define PWM_3_PWM_MODE                       (4lu)
#define PWM_3_PWM_OUT_N_INVERT               (1lu)
#define PWM_3_PWM_OUT_INVERT                 (0lu)
#define PWM_3_PWM_ALIGN                      (1lu)
...
#define PWM_3_PWM_STOP_SIGNAL_MODE           (1lu)
...
#define PWM_3_PWM_START_SIGNAL_PRESENT       (1lu)
#define PWM_3_PWM_STOP_SIGNAL_PRESENT        (1lu)
#define PWM_3_PWM_SWITCH_SIGNAL_PRESENT      (0lu)

/* Interrupt Mask */
#define PWM_3_PWM_INTERRUPT_MASK             (2lu)
