...
#define UART_RS_485_REMOVE_CTS_SCLK_PIN      (1u)
#define UART_RS_485_REMOVE_RTS_SS0_PIN      (1u)
...
#define UART_RS_485_CTS_SCLK_PIN     (0u == UART_RS_485_REMOVE_CTS_SCLK_PIN)
#define UART_RS_485_RTS_SS0_PIN     (0u == UART_RS_485_REMOVE_RTS_SS0_PIN)
...
****************************************/
    ...
    #include "UART_RS_485_uart_cts_spi_sclk.h"
#endif /* (UART_RS_485_CTS_SCLK) */

#if (UART_RS_485_RTS_SS0_PIN)
    #include "UART_RS_485_uart_rts_spi_ss0.h"
...
#if (UART_RS_485_CTS_SCLK_PIN)
    #define UART_RS_485_CTS_SCLK_HSIOM_REG   (*(reg32 *) UART_RS_485_uart_cts_spi_sclk__0__HSIOM)
    #define UART_RS_485_CTS_SCLK_HSIOM_PTR   ( (reg32 *) UART_RS_485_uart_cts_spi_sclk__0__HSIOM)
    
    #define UART_RS_485_CTS_SCLK_HSIOM_MASK      (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define UART_RS_485_CTS_SCLK_HSIOM_POS       (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define UART_RS_485_CTS_SCLK_HSIOM_SEL_GPIO  (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define UART_RS_485_CTS_SCLK_HSIOM_SEL_I2C   (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define UART_RS_485_CTS_SCLK_HSIOM_SEL_SPI   (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define UART_RS_485_CTS_SCLK_HSIOM_SEL_UART  (UART_RS_485_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (UART_RS_485_CTS_SCLK_PIN) */

#if (UART_RS_485_RTS_SS0_PIN)
    #define UART_RS_485_RTS_SS0_HSIOM_REG   (*(reg32 *) UART_RS_485_uart_rts_spi_ss0__0__HSIOM)
    #define UART_RS_485_RTS_SS0_HSIOM_PTR   ( (reg32 *) UART_RS_485_uart_rts_spi_ss0__0__HSIOM)
    
    #define UART_RS_485_RTS_SS0_HSIOM_MASK      (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define UART_RS_485_RTS_SS0_HSIOM_POS       (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define UART_RS_485_RTS_SS0_HSIOM_SEL_GPIO  (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define UART_RS_485_RTS_SS0_HSIOM_SEL_I2C   (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define UART_RS_485_RTS_SS0_HSIOM_SEL_SPI   (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(UART_RS_485_CY_SCBIP_V0 || UART_RS_485_CY_SCBIP_V1)
    #define UART_RS_485_RTS_SS0_HSIOM_SEL_UART  (UART_RS_485_uart_rts_spi_ss0__0__HSIOM_UART)
...
#define UART_RS_485_CTS_SCLK_PIN_INDEX       (2u)
#define UART_RS_485_RTS_SS0_PIN_INDEX       (3u)
...
#define UART_RS_485_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << UART_RS_485_CTS_SCLK_PIN_INDEX)
#define UART_RS_485_RTS_SS0_PIN_MASK     ((uint32) 0x01u << UART_RS_485_RTS_SS0_PIN_INDEX)
...
#if (UART_RS_485_RTS_SS0_PIN)
    #define UART_RS_485_CHECK_RTS_SS0_PIN_USED \
                (UART_RS_485_PIN_DM_ALG_HIZ != \
                    UART_RS_485_GET_P4_PIN_DM(UART_RS_485_uart_rts_spi_ss0_PC, \
                                                   UART_RS_485_uart_rts_spi_ss0_SHIFT))
#endif /* (UART_RS_485_RTS_SS0_PIN) */
...
#define UART_RS_485_REMOVE_SCLK_PIN                UART_RS_485_REMOVE_CTS_SCLK_PIN
#endif /* UART_RS_485_REMOVE_SCLK_PIN */
#ifndef UART_RS_485_REMOVE_SS0_PIN
#define UART_RS_485_REMOVE_SS0_PIN                 UART_RS_485_REMOVE_RTS_SS0_PIN
...
#define UART_RS_485_SCLK_PIN               UART_RS_485_CTS_SCLK_PIN
#endif /* UART_RS_485_SCLK_PIN */
#ifndef UART_RS_485_SS0_PIN
#define UART_RS_485_SS0_PIN                UART_RS_485_RTS_SS0_PIN
    ...
    #define UART_RS_485_SCLK_HSIOM_REG     UART_RS_485_CTS_SCLK_HSIOM_REG
    #define UART_RS_485_SCLK_HSIOM_PTR     UART_RS_485_CTS_SCLK_HSIOM_PTR
    #define UART_RS_485_SCLK_HSIOM_MASK    UART_RS_485_CTS_SCLK_HSIOM_MASK
    #define UART_RS_485_SCLK_HSIOM_POS     UART_RS_485_CTS_SCLK_HSIOM_POS
    #endif /* UART_RS_485_SCLK_HSIOM_REG */
#endif /* (UART_RS_485_SCLK_PIN) */

#if (UART_RS_485_SS0_PIN)
    #ifndef UART_RS_485_SS0_HSIOM_REG
    #define UART_RS_485_SS0_HSIOM_REG      UART_RS_485_RTS_SS0_HSIOM_REG
    #define UART_RS_485_SS0_HSIOM_PTR      UART_RS_485_RTS_SS0_HSIOM_PTR
    #define UART_RS_485_SS0_HSIOM_MASK     UART_RS_485_RTS_SS0_HSIOM_MASK
    #define UART_RS_485_SS0_HSIOM_POS      UART_RS_485_RTS_SS0_HSIOM_POS
...
#define UART_RS_485_SCLK_PIN_INDEX             UART_RS_485_CTS_SCLK_PIN_INDEX
#endif /* UART_RS_485_SCLK_PIN_INDEX */
#ifndef UART_RS_485_SS0_PIN_INDEX
#define UART_RS_485_SS0_PIN_INDEX              UART_RS_485_RTS_SS0_PIN_INDEX
...
#define UART_RS_485_SCLK_PIN_MASK             UART_RS_485_CTS_SCLK_PIN_MASK
#endif /* UART_RS_485_SCLK_PIN_MASK */
#ifndef UART_RS_485_SS0_PIN_MASK
#define UART_RS_485_SS0_PIN_MASK              UART_RS_485_RTS_SS0_PIN_MASK
